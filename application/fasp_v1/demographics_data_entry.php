...
<!--                                                            <option   <?=($office_level==3)?' selected ':''?>  value="3">District</option>-->
						...
						<div class="portlet-body">
                                                        <div class="">
                                                            ...
                                                            <div class="col-md-12 btn green justify">Demographic Values <span class="badge badge-warning"><?=(!empty($master_id)?'Already Saved':'New Entry')?></span></div>
                                                                    <div class="" id="div_table">
                                                                                ...
                                                                                <table  class="table table-condensed table-hover table-bordered">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            {
                                                                                                echo '<td title="'.$col_data['long_name'].'">'.wordwrap($col_data['long_name'],30,"<br />").'</td>';
                                                                                                $to3_count++;
                                                                                            }
                                                                                            ?>
                                                                                        </tr>
                                                                                        ...
                                                                                        <?php
                                                                                           foreach($prov_arr as $pro_id => $pro_name)
                                                                                           {
                                                                                               ...
                                                                                               foreach($all_cols as $col_id => $col_data)
                                                                                               {
                                                                                                   ...
                                                                                                   /*if($col_id != '5'){
                                                                                                       if(isset($dmg_previous_data[$pro_id][5])){
                                                                                                           $perc = ($val * 100) / $dmg_previous_data[$pro_id][5];
                                                                                                       }
                                                                                                       else{
                                                                                                           $perc = ''; 
                                                                                                       }
                                                                                                       
                                                                                                        echo '<input value="'.number_format($perc,2).'"   style="width:40px;padding:0px" maxlength="5" name="percentage_'.$task_order.'_'.$pro_id.'_'.$col_id.'"  id="percentage_'.$task_order.'_'.$pro_id.'_'.$col_id.'" type="text" class="form-control pull-left">';
                                                                                                        echo '% = ';
                                                                                                   }*/
                                                                                                   //style="width:90px;
                                                                                                   echo '<input value="'.$val.'"   name="input_'.$task_order.'_'.$pro_id.'_'.$col_id.'"  id="input_'.$task_order.'_'.$pro_id.'_'.$col_id.'" type="text" class="grid_input_number form-control pull-right right"></td>';
                                                                                               }
                                                                                               echo '</tr>';
                                                                                           }
                                                                                           ?>
                                                                        ...
                                                                        <div class="row col-md-12">
                                                                            <div class="right">
                                                                                ...
                                                                                <input class="btn btn-green" type="submit" value="<?=(isset($master_id))?'Update':'Save'?>">
                                                                            </div>
                                                                        </div>
