...
$strSql = " INSERT INTO `fq_non_lmis_consumption_master` 
            SET 
   ...
   ";
//echo $strSql;
$rsSql = mysql_query($strSql) or die('Err inserting consumption P')  ;
...
header("location:consumption_non_lmis_data_entry.php?err=0");
exit;
